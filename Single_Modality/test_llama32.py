...
if __name__ == "__main__":
    ...
    TXT_FILE = f'results/llama32_{TEST_DATASET}_{TEST_MODALITY}.txt'

    API_KEY = "sk-cc842e903f4b4eb78bdfe349418e1a66"  # Replace with your API key of llama32
    ...
    for each_img in all_imgs:
        ...
        my_messages = [
            {
                "role": "system",
                "content": [{"text": TEXT_QUERY_SYSTEM}]
            },
            {
                "role": "user",
                "content": [
                    {"image": each_img},
                    {"text": TEXT_QUERY_USER}
                ]
            }
        ]
        ...
        for i in range(TEST_TIMES):
            ...
            try:
                res_data = re.sub("[\r\n]", "", str(response.output.choices[0].message.content[0]["text"]))
            except Exception as e:
                res_data = re.sub("[\r\n]", "", str(sys.exc_info()))
