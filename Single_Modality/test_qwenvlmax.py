...
if __name__ == "__main__":
    ...
    TXT_FILE = f'results/qwenvlmax_{TEST_DATASET}_{TEST_MODALITY}.txt'

    API_KEY = "sk-cc842e903f4b4eb78bdfe349418e1a66"  # Replace with your API key of Qwen-VL-Max
    ...
    for each_img in all_imgs:
        ...
        for i in range(TEST_TIMES):
            while True:
                try:
                    response = client.chat.completions.create(model = "qwen-vl-max", messages = my_messages)
                    break
