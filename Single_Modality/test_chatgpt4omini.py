...
if __name__ == "__main__":
    ...
    TXT_FILE = f'results/chatgpt4omini_{TEST_DATASET}_{TEST_MODALITY}.txt'

    API_KEY = "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"  # Replace with your API key of ChatGPT
