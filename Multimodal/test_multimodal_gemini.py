...
if __name__ == "__main__":
    ...
    TXT_FILE = f'results/multimodal_gemini_{TEST_DATASET}_{TEST_SEQUENCE}.txt'
    ...
    for i in range(len(file_paths_clinical)):
        ...
        api_keys = "AIzaSyAQNrLLNp3FoSs8j_asLZTq2-Ma1RZFk94"  # Replace with your API key of Gemini
        ...
        genai.configure(api_key=api_keys, transport='rest')
        model = genai.GenerativeModel(model_name="gemini-1.5-flash", system_instruction=system_message_en)
